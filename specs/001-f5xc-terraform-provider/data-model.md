...
**Resource**: `f5distributedcloud_namespace`
...
**Resource**: `f5distributedcloud_http_loadbalancer`
...
resource "f5distributedcloud_http_loadbalancer" "example" {
  ...
  app_firewall {
    name      = f5distributedcloud_app_firewall.waf.name
    namespace = f5distributedcloud_namespace.example.name
  }
...
**Resource**: `f5distributedcloud_tcp_loadbalancer`
...
resource "f5distributedcloud_tcp_loadbalancer" "example" {
  ...
  origin_pools {
    pool {
      name      = f5distributedcloud_origin_pool.database.name
      namespace = f5distributedcloud_namespace.example.name
    }
    weight = 100
  }
...
**Resource**: `f5distributedcloud_origin_pool`
...
resource "f5distributedcloud_origin_pool" "example" {
  ...
  healthcheck {
    name      = f5distributedcloud_healthcheck.http.name
    namespace = f5distributedcloud_namespace.example.name
  }
...
**Resource**: `f5distributedcloud_app_firewall`
...
**Resource**: `f5distributedcloud_cloud_credentials`
...
resource "f5distributedcloud_cloud_credentials" "aws_key" {
  name      = "aws-key"
  namespace = "system"
...
**Resource**: `f5distributedcloud_aws_vpc_site`
...
resource "f5distributedcloud_aws_vpc_site" "example" {
  ...
  aws_cred {
    name      = f5distributedcloud_cloud_credentials.aws.name
    namespace = "system"
  }
...
**Resource**: `f5distributedcloud_dns_load_balancer`
...
resource "f5distributedcloud_dns_load_balancer" "example" {
  ...
  dns_lb_pool {
    pool {
      name      = f5distributedcloud_dns_lb_pool.primary.name
      namespace = f5distributedcloud_namespace.example.name
    }
    priority = 1
  }
...
terraform import f5distributedcloud_namespace.example production
```
