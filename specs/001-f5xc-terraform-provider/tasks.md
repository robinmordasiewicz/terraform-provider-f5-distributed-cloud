...
- [ ] T041 [P] [US2] Create namespace example in examples/resources/f5distributedcloud_namespace/resource.tf
...
- [ ] T054 [P] [US3] Create http_loadbalancer example in examples/resources/f5distributedcloud_http_loadbalancer/resource.tf
...
- [ ] T067 [P] [US4] Create origin_pool example in examples/resources/f5distributedcloud_origin_pool/resource.tf
...
- [ ] T085 [P] [US5] Create cloud_credentials example in examples/resources/f5distributedcloud_cloud_credentials/resource.tf
- [ ] T086 [P] [US5] Create aws_vpc_site example in examples/resources/f5distributedcloud_aws_vpc_site/resource.tf
...
- [ ] T098 [P] [US6] Create app_firewall example in examples/resources/f5distributedcloud_app_firewall/resource.tf
