...
// WAFResourceModel describes the resource data model.
...
// APIWAF represents the API request/response structure.
type APIWAF struct {
	Metadata   APIMetadata        `json:"metadata"`
	Spec       APIWAFSpec         `json:"spec"`
...
// APIWAFSpec represents the WAF specification.
type APIWAFSpec struct {
}

// ToAPIRequest converts the Terraform model to API request format.
func (m *WAFResourceModel) ToAPIRequest() *APIWAF {
	apiReq := &APIWAF{
...
func (m *WAFResourceModel) FromAPIResponse(resp *APIWAF) {
