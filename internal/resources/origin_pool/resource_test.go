		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("f5xc_origin_pool.test", "name", rName),
					resource.TestCheckResourceAttr("f5xc_origin_pool.test", "namespace", namespace),
					resource.TestCheckResourceAttrSet("f5xc_origin_pool.test", "id"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check:  resource.TestCheckResourceAttr("f5xc_origin_pool.test", "description", "Initial"),
			},
			{
				Config: testAccOriginPoolResourceConfig(rName, namespace, "Updated"),
				Check:  resource.TestCheckResourceAttr("f5xc_origin_pool.test", "description", "Updated"),
			},
		},
	})
}
