		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("f5distributedcloud_cloud_site.test", "name", rName),
					resource.TestCheckResourceAttr("f5distributedcloud_cloud_site.test", "site_type", "aws_vpc_site"),
					resource.TestCheckResourceAttr("f5distributedcloud_cloud_site.test", "cloud_provider", "aws"),
					resource.TestCheckResourceAttrSet("f5distributedcloud_cloud_site.test", "id"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("f5distributedcloud_cloud_site.test", "name", rName),
					resource.TestCheckResourceAttr("f5distributedcloud_cloud_site.test", "site_type", "azure_vnet_site"),
					resource.TestCheckResourceAttr("f5distributedcloud_cloud_site.test", "cloud_provider", "azure"),
					resource.TestCheckResourceAttrSet("f5distributedcloud_cloud_site.test", "id"),
				),
			},
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("f5distributedcloud_cloud_site.test", "name", rName),
					resource.TestCheckResourceAttr("f5distributedcloud_cloud_site.test", "site_type", "gcp_vpc_site"),
					resource.TestCheckResourceAttr("f5distributedcloud_cloud_site.test", "cloud_provider", "gcp"),
					resource.TestCheckResourceAttrSet("f5distributedcloud_cloud_site.test", "id"),
				),
			},
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check:  resource.TestCheckResourceAttr("f5distributedcloud_cloud_site.test", "description", "Initial"),
			},
			{
				Config: testAccCloudSiteResourceConfigAWS(rName, "Updated"),
				Check:  resource.TestCheckResourceAttr("f5distributedcloud_cloud_site.test", "description", "Updated"),
			},
		},
	})
}
...
func TestAccCloudSiteResource_import(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:            "f5distributedcloud_cloud_site.test",
				ImportState:             true,
...
resource "f5distributedcloud_cloud_site" "test" {
  name           = %[1]q
  description    = %[2]q
