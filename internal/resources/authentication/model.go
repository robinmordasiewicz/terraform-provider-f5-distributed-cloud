...
// APIAuthenticationSpec represents the Authentication specification.
type APIAuthenticationSpec struct {
}

// ToAPIRequest converts the Terraform model to API request format.
func (m *AuthenticationResourceModel) ToAPIRequest() *APIAuthentication {
	apiReq := &APIAuthentication{
...
func (m *AuthenticationResourceModel) FromAPIResponse(resp *APIAuthentication) {
