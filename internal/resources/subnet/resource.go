...
func (r *SubnetResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	tflog.Debug(ctx, "Creating Subnet", map[string]interface{}{"name": data.Name.ValueString()})
	apiReq := data.ToAPIRequest()
	var apiResp APISubnet
	path := fmt.Sprintf("/config/namespaces/%s/subnets", data.Namespace.ValueString())
...
func (r *SubnetResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	var apiResp APISubnet
	path := fmt.Sprintf("/config/namespaces/%s/subnets/%s", data.Namespace.ValueString(), data.Name.ValueString())
...
func (r *SubnetResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	tflog.Debug(ctx, "Updating Subnet", map[string]interface{}{"name": data.Name.ValueString()})
	apiReq := data.ToAPIRequest()
	var apiResp APISubnet
	path := fmt.Sprintf("/config/namespaces/%s/subnets/%s", data.Namespace.ValueString(), data.Name.ValueString())
...
func (r *SubnetResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	tflog.Debug(ctx, "Deleting Subnet", map[string]interface{}{"name": data.Name.ValueString()})
	path := fmt.Sprintf("/config/namespaces/%s/subnets/%s", data.Namespace.ValueString(), data.Name.ValueString())
...
func (r *SubnetResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	...
	var apiResp APISubnet
	path := fmt.Sprintf("/config/namespaces/%s/subnets/%s", parts[0], parts[1])
	if err := r.client.Get(ctx, path, &apiResp); err != nil {
