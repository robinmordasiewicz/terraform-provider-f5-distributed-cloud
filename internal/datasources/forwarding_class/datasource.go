...
var _ datasource.DataSource = &ForwardingClassDataSource{}
...
type APIForwardingClassDS struct {
	Metadata struct {
...
func (d *ForwardingClassDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Fetches information about an existing F5 Distributed Cloud ForwardingClass.",
		Attributes: map[string]schema.Attribute{
			"id": schema.StringAttribute{
				Description: "Unique identifier of the forwarding_class.",
				Computed:    true,
			},
			"name": schema.StringAttribute{
				Description: "Name of the forwarding_class to look up.",
				Required:    true,
			},
			"namespace": schema.StringAttribute{
				Description: "Namespace where the forwarding_class exists.",
				Required:    true,
			},
			"description": schema.StringAttribute{
				Description: "Description of the forwarding_class.",
				Computed:    true,
			},
		},
	}
...
func (d *ForwardingClassDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var apiResp APIForwardingClassDS
