...
var _ datasource.DataSource = &ApmDataSource{}
...
func (d *ApmDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Fetches information about an existing F5 Distributed Cloud Apm.",
		Attributes: map[string]schema.Attribute{
			"id": schema.StringAttribute{
				Description: "Unique identifier of the apm.",
				Computed:    true,
			},
			"name": schema.StringAttribute{
				Description: "Name of the apm to look up.",
				Required:    true,
			},
			"namespace": schema.StringAttribute{
				Description: "Namespace where the apm exists.",
				Required:    true,
			},
			"description": schema.StringAttribute{
				Description: "Description of the apm.",
				Computed:    true,
			},
		},
	}
