...
var _ datasource.DataSource = &DataTypeDataSource{}
...
func (d *DataTypeDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Fetches information about an existing F5 Distributed Cloud DataType.",
		Attributes: map[string]schema.Attribute{
			"id": schema.StringAttribute{
				Description: "Unique identifier of the data_type.",
				Computed:    true,
			},
			"name": schema.StringAttribute{
				Description: "Name of the data_type to look up.",
				Required:    true,
			},
			"namespace": schema.StringAttribute{
				Description: "Namespace where the data_type exists.",
				Required:    true,
			},
			"description": schema.StringAttribute{
				Description: "Description of the data_type.",
				Computed:    true,
			},
		},
	}
