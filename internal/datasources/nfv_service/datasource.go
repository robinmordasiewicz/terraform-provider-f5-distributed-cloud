...
var _ datasource.DataSource = &NfvServiceDataSource{}
...
func (d *NfvServiceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Fetches information about an existing F5 Distributed Cloud NfvService.",
		Attributes: map[string]schema.Attribute{
			"id": schema.StringAttribute{
				Description: "Unique identifier of the nfv_service.",
				Computed:    true,
			},
			"name": schema.StringAttribute{
				Description: "Name of the nfv_service to look up.",
				Required:    true,
			},
			"namespace": schema.StringAttribute{
				Description: "Namespace where the nfv_service exists.",
				Required:    true,
			},
			"description": schema.StringAttribute{
				Description: "Description of the nfv_service.",
				Computed:    true,
			},
		},
	}
