...
var _ datasource.DataSource = &Ike1DataSource{}
...
func (d *Ike1DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Fetches information about an existing F5 Distributed Cloud Ike1.",
		Attributes: map[string]schema.Attribute{
			"id": schema.StringAttribute{
				Description: "Unique identifier of the ike1.",
				Computed:    true,
			},
			"name": schema.StringAttribute{
				Description: "Name of the ike1 to look up.",
				Required:    true,
			},
			"namespace": schema.StringAttribute{
				Description: "Namespace where the ike1 exists.",
				Required:    true,
			},
			"description": schema.StringAttribute{
				Description: "Description of the ike1.",
				Computed:    true,
			},
		},
	}
