---
page_title: "f5_distributed_cloud_workload Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_workload (Resource)
...
```shell
terraform import f5_distributed_cloud_workload.example namespace/name
```
