---
page_title: "f5_distributed_cloud_site_mesh_group Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_site_mesh_group (Resource)
...
```shell
terraform import f5_distributed_cloud_site_mesh_group.example namespace/name
```
