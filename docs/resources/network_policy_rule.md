---
page_title: "f5_distributed_cloud_network_policy_rule Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_network_policy_rule (Resource)
...
```shell
terraform import f5_distributed_cloud_network_policy_rule.example namespace/name
```
