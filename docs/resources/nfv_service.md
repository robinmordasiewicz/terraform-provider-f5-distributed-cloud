---
page_title: "f5_distributed_cloud_nfv_service Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_nfv_service (Resource)
...
```shell
terraform import f5_distributed_cloud_nfv_service.example namespace/name
```
