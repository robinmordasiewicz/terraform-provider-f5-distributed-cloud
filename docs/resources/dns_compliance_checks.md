---
page_title: "f5xc_dns_compliance_checks Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
```shell
terraform import f5xc_dns_compliance_checks.example namespace/name
```
