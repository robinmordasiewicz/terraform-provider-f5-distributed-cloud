---
page_title: "f5_distributed_cloud_contact Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_contact (Resource)
...
```shell
terraform import f5_distributed_cloud_contact.example namespace/name
```
