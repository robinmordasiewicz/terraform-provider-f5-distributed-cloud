---
page_title: "f5_distributed_cloud_receiver Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_receiver (Resource)
...
```shell
terraform import f5_distributed_cloud_receiver.example namespace/name
```
