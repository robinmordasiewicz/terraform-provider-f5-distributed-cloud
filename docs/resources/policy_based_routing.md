---
page_title: "f5xc_policy_based_routing Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
```shell
terraform import f5xc_policy_based_routing.example namespace/name
```
