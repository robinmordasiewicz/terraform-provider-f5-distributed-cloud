---
page_title: "f5_distributed_cloud_securemesh_site Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
  Secure Mesh site defines a required parameters that can be used in CRUD, to create and manage an Secure Mesh site.
---

# f5_distributed_cloud_securemesh_site (Resource)
...
```shell
terraform import f5_distributed_cloud_securemesh_site.example namespace/name
```
