---
page_title: "f5_distributed_cloud_secret_management_access Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_secret_management_access (Resource)
...
```shell
terraform import f5_distributed_cloud_secret_management_access.example namespace/name
```
