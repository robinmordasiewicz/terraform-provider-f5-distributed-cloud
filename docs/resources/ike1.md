---
page_title: "f5_distributed_cloud_ike1 Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_ike1 (Resource)
...
```shell
terraform import f5_distributed_cloud_ike1.example namespace/name
```
