---
page_title: "f5xc_code_base_integration Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
```shell
terraform import f5xc_code_base_integration.example namespace/name
```
