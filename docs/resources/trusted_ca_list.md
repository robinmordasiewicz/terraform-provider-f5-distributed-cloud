---
page_title: "f5_distributed_cloud_trusted_ca_list Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
  A Root CA Certificate represents list of trusted root CAs
---

# f5_distributed_cloud_trusted_ca_list (Resource)
...
```shell
terraform import f5_distributed_cloud_trusted_ca_list.example namespace/name
```
