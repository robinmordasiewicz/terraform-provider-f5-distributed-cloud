---
page_title: "f5_distributed_cloud_managed_tenant Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_managed_tenant (Resource)
...
```shell
terraform import f5_distributed_cloud_managed_tenant.example namespace/name
```
