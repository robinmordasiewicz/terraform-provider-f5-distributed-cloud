---
page_title: "f5xc_alert_template Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
  BRM Alerts Alert Template
---

# f5xc_alert_template (Resource)
...
```shell
terraform import f5xc_alert_template.example namespace/name
```
