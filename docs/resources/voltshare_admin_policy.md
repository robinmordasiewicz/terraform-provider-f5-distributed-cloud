---
page_title: "f5_distributed_cloud_voltshare_admin_policy Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_voltshare_admin_policy (Resource)
...
```hcl
resource "f5_distributed_cloud_voltshare_admin_policy" "example" {
...
```shell
terraform import f5_distributed_cloud_voltshare_admin_policy.example namespace/name
```
