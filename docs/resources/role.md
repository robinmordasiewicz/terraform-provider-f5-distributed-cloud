---
page_title: "f5_distributed_cloud_role Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_role (Resource)
...
```shell
terraform import f5_distributed_cloud_role.example namespace/name
```
