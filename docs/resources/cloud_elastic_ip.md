---
page_title: "f5_distributed_cloud_cloud_elastic_ip Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
  Cloud Elastic IP object represents a cloud elastic IP address that are created for a cloud site
---

# f5_distributed_cloud_cloud_elastic_ip (Resource)
...
```shell
terraform import f5_distributed_cloud_cloud_elastic_ip.example namespace/name
```
