---
page_title: "f5xc_tenant_configuration Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
```shell
terraform import f5xc_tenant_configuration.example namespace/name
```
