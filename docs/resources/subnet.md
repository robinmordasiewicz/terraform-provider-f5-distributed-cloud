---
page_title: "f5_distributed_cloud_subnet Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
  Subnet object is used to support VMs/pods with multiple interfaces, with each one in a different subnet.
---

# f5_distributed_cloud_subnet (Resource)
...
```shell
terraform import f5_distributed_cloud_subnet.example namespace/name
```
