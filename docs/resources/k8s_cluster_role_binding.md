---
page_title: "f5xc_k8s_cluster_role_binding Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
```shell
terraform import f5xc_k8s_cluster_role_binding.example namespace/name
```
