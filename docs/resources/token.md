---
page_title: "f5_distributed_cloud_token Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_token (Resource)
...
```shell
terraform import f5_distributed_cloud_token.example namespace/name
```
