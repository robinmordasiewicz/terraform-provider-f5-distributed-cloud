---
page_title: "f5xc_k8s_pod_security_admission Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
```shell
terraform import f5xc_k8s_pod_security_admission.example namespace/name
```
