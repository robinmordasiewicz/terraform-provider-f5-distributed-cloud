---
page_title: "f5xc_malicious_user_mitigation Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
```shell
terraform import f5xc_malicious_user_mitigation.example namespace/name
```
