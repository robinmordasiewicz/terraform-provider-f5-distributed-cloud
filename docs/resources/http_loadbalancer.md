---
page_title: "f5_distributed_cloud_http_loadbalancer Resource - terraform-provider-f5-distributed-cloud"
subcategory: ""
description: |-
...
# f5_distributed_cloud_http_loadbalancer (Resource)
...
```shell
terraform import f5_distributed_cloud_http_loadbalancer.example namespace/name
```
