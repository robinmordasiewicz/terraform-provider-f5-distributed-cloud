...
### Resources
- `f5xc_namespace` - Manage F5 XC namespaces
- `f5xc_origin_pool` - Manage origin server pools
- `f5xc_http_loadbalancer` - Manage HTTP load balancers
- `f5xc_cloud_site` - Manage cloud sites (AWS VPC, Azure VNET, GCP VPC)
- `f5xc_app_firewall` - Manage application firewall (WAF) policies

### Data Sources
- `f5xc_namespace` - Read existing namespaces
- `f5xc_origin_pool` - Read existing origin pools
