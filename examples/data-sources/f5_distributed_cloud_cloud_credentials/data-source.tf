...
data "f5_distributed_cloud_cloud_credentials" "aws" {
...
output "creds_id" {
  ...
  value       = data.f5_distributed_cloud_cloud_credentials.aws.id
}

output "creds_description" {
  description = "Description of the Cloud Credentials"
  value       = data.f5_distributed_cloud_cloud_credentials.aws.description
}

output "creds_cloud_type" {
  description = "Type of cloud provider (aws, azure, gcp)"
  value       = data.f5_distributed_cloud_cloud_credentials.aws.cloud_type
}
...
resource "f5_distributed_cloud_aws_vpc_site" "example" {
  ...
  cloud_credentials_ref = data.f5_distributed_cloud_cloud_credentials.aws.name
}
