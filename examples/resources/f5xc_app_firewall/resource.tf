...
resource "f5xc_app_firewall" "basic" {
...
resource "f5xc_app_firewall" "with_bot_protection" {
...
resource "f5xc_app_firewall" "custom_blocking" {
...
resource "f5xc_app_firewall" "labeled" {
...
resource "f5xc_app_firewall" "comprehensive" {
