...
resource "f5_distributed_cloud_origin_pool" "public_ip" {
  name        = "public-ip-pool"
...
resource "f5_distributed_cloud_origin_pool" "dns_name" {
  name        = "dns-pool"
  namespace   = "my-namespace"
...
resource "f5_distributed_cloud_origin_pool" "private_ip" {
...
resource "f5_distributed_cloud_origin_pool" "custom_lb" {
  name        = "custom-lb-pool"
  namespace   = "my-namespace"
