...
resource "f5_distributed_cloud_http_loadbalancer" "basic" {
  name        = "my-http-lb"
...
resource "f5_distributed_cloud_http_loadbalancer" "with_origin_pool" {
...
resource "f5_distributed_cloud_http_loadbalancer" "https" {
  name        = "my-https-lb"
  namespace   = "my-namespace"
...
resource "f5_distributed_cloud_http_loadbalancer" "multi_domain" {
...
resource "f5_distributed_cloud_http_loadbalancer" "no_waf" {
  name        = "no-waf-lb"
  namespace   = "my-namespace"
