...
resource "f5xc_cloud_site" "aws_site" {
  name           = "my-aws-site"
...
resource "f5xc_cloud_site" "aws_ha_site" {
  name           = "my-aws-ha-site"
...
resource "f5xc_cloud_site" "azure_site" {
  name           = "my-azure-site"
...
resource "f5xc_cloud_site" "gcp_site" {
  name           = "my-gcp-site"
...
resource "f5xc_cloud_site" "aws_with_workers" {
